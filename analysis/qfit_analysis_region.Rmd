...
qfit_rows <- quos(
  ...
  "Colorectal cancer if qFIT >= 10" = first_table_row(crc_diagnosis, data_filter = qfit_pos),
  "Colorectal cancer if qFIT = 0" = first_table_row(crc_diagnosis, data_filter = qfit == 0),
  "Colorectal cancer if qFIT 1 to 9" = first_table_row(crc_diagnosis, data_filter = qfit > 0 & qfit < 10),
