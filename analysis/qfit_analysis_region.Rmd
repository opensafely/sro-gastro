...
write_csv(cum_prop_data_over_50$cum_props %>% select(-n), "../output/cum_prop_data.csv")
write_csv(cum_prop_data_all_ages$cum_props %>% select(-n), "../output/cum_prop_data_all_ages.csv")
```
